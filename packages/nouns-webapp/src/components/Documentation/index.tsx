        ...
        <Accordion flush>
          ...
          <Accordion.Item eventKey="1" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p className={classes.aboutText}>
                <Trans>
                  The NounsBrazil Auction Contract will act as a self-sufficient Noun generation and
          ...
          <Accordion.Item eventKey="2" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <Trans>
                ...
                Noun auctions. Each Noun is an irrevocable member of NounsBrazil DAO and entitled to one
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  ...
                  statements or other rules governing Noun trait scarcity, which makes all NounsBrazil
