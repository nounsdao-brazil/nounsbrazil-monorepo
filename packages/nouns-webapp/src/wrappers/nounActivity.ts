...
// Wrapper type around NounBrazil events.
...
/**
 * Fetch list of ProposalVoteEvents representing the voting history of the given NounBrazil
 * @param nounId Id of NounBrazil who's voting history will be fetched
 */
const useNounProposalVoteEvents = (nounId: number): NounProfileEventFetcherResponse => {
  ...
  const filteredProposals = proposals.filter((p: Proposal, id: number) => {
    ...
    // Filter props from before the NounBrazil was born
...
/**
 * Fetch list of TransferEvents for given NounBrazil
 * @param nounId Id of NounBrazil who's transfer history we will fetch
 */
...
/**
 * Fetch list of DelegationEvents for given NounBrazil
 * @param nounId Id of NounBrazil who's transfer history we will fetch
 */
...
/**
 * Fetch list of all events for given NounBrazil (ex: voting, transfer, delegation, etc.)
 * @param nounId Id of NounBrazil who's history we will fetch
 */
