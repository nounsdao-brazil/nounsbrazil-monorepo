...
This package contains the source for the NounsBrazil webapp at [nouns.wtf](https://nouns.wtf).
...
Select the network and connect to your local NounsBrazil webapp to interact with simnet
