...
/**
 * Get encoded part and background information using a NounBrazil seed
 * @param seed The NounBrazil seed
 */
...
/**
 * Generate a random NounBrazil seed
 * @param seed The NounBrazil seed
 */
...
/**
 * Emulates the NounsSeeder.sol methodology for generating a NounBrazil seed
 * @param nounId The NounBrazil tokenId used to create pseudorandomness
