...
task(
  ...
  console.log(`NounsBrazil ERC721 address: ${contracts.NounsToken.instance.address}`);
  console.log(`NounsBrazil DAO Executor address: ${contracts.NounsDAOExecutor.instance.address}`);
  console.log(`NounsBrazil DAO Proxy address: ${contracts.NounsDAOProxy.instance.address}`);
